...
*ApplicationsApi* | [**export_environment_configuration_into_terraform**](docs/ApplicationsApi.md#export_environment_configuration_into_terraform) | **GET** /environment/{environmentId}/terraformExport | Export full environment and its resources into Terraform manifests
