...
class HelmResponseAllOfSourceOneOfGit(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HelmResponseAllOfSourceOneOfGit:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HelmResponseAllOfSourceOneOfGit:
        """Create an instance of HelmResponseAllOfSourceOneOfGit from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HelmResponseAllOfSourceOneOfGit.parse_obj(obj)

        _obj = HelmResponseAllOfSourceOneOfGit.parse_obj({
