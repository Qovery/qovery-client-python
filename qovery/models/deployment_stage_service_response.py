...
class DeploymentStageServiceResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeploymentStageServiceResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeploymentStageServiceResponse:
        """Create an instance of DeploymentStageServiceResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeploymentStageServiceResponse.parse_obj(obj)

        _obj = DeploymentStageServiceResponse.parse_obj({
            "id": obj.get("id"),
