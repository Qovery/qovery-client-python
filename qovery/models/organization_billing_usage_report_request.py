...
class OrganizationBillingUsageReportRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationBillingUsageReportRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationBillingUsageReportRequest:
        """Create an instance of OrganizationBillingUsageReportRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrganizationBillingUsageReportRequest.parse_obj(obj)

        _obj = OrganizationBillingUsageReportRequest.parse_obj({
