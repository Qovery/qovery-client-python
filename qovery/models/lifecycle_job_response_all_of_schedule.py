...
class LifecycleJobResponseAllOfSchedule(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LifecycleJobResponseAllOfSchedule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LifecycleJobResponseAllOfSchedule:
        """Create an instance of LifecycleJobResponseAllOfSchedule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LifecycleJobResponseAllOfSchedule.parse_obj(obj)

        _obj = LifecycleJobResponseAllOfSchedule.parse_obj({
