...
class BaseJobResponseAllOfSource(BaseModel):
    ...
    actual_instance: Optional[Union[BaseJobResponseAllOfSourceOneOf, BaseJobResponseAllOfSourceOneOf1]] = None
    one_of_schemas: List[str] = Literal["BaseJobResponseAllOfSourceOneOf", "BaseJobResponseAllOfSourceOneOf1"]
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = BaseJobResponseAllOfSource.model_construct()
        error_messages = []
        match = 0
