...
class DeployAllRequest(BaseModel):
    ...
    DeployAllRequest
    """ # noqa: E501
    applications: Optional[List[DeployAllRequestApplicationsInner]] = None
    databases: Optional[List[StrictStr]] = None
    containers: Optional[List[DeployAllRequestContainersInner]] = None
    jobs: Optional[List[DeployAllRequestJobsInner]] = None
    helms: Optional[List[DeployAllRequestHelmsInner]] = None
    __properties: ClassVar[List[str]] = ["applications", "databases", "containers", "jobs", "helms"]
