...
class ContainerSource(BaseModel):
    ...
    __properties = ["image_name", "tag", "registry_id", "registry"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContainerSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContainerSource:
        """Create an instance of ContainerSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContainerSource.parse_obj(obj)

        _obj = ContainerSource.parse_obj({
