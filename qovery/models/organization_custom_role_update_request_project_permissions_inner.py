...
class OrganizationCustomRoleUpdateRequestProjectPermissionsInner(BaseModel):
    """
    ...
    permissions: Optional[conlist(OrganizationCustomRoleUpdateRequestProjectPermissionsInnerPermissionsInner)] = Field(None, description="Mandatory if `is_admin` is `false`   Should contain an entry for every environment type: - `DEVELOPMENT` - `PREVIEW` - `STAGING` - `PRODUCTION` ")
    additional_properties: Dict[str, Any] = {}
    __properties = ["project_id", "is_admin", "permissions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationCustomRoleUpdateRequestProjectPermissionsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationCustomRoleUpdateRequestProjectPermissionsInner:
        """Create an instance of OrganizationCustomRoleUpdateRequestProjectPermissionsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrganizationCustomRoleUpdateRequestProjectPermissionsInner.parse_obj(obj)

        _obj = OrganizationCustomRoleUpdateRequestProjectPermissionsInner.parse_obj({
