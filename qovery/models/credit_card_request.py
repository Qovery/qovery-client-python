...
class CreditCardRequest(BaseModel):
    ...
    __properties = ["number", "cvv", "expiry_month", "expiry_year"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreditCardRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreditCardRequest:
        """Create an instance of CreditCardRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreditCardRequest.parse_obj(obj)

        _obj = CreditCardRequest.parse_obj({
