...
class ApplicationDeploymentRestrictionRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationDeploymentRestrictionRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationDeploymentRestrictionRequest:
        """Create an instance of ApplicationDeploymentRestrictionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationDeploymentRestrictionRequest.parse_obj(obj)

        _obj = ApplicationDeploymentRestrictionRequest.parse_obj({
            "mode": obj.get("mode"),
            "type": obj.get("type"),
            "value": obj.get("value")
        })
