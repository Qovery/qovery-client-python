...
class OrganizationEditRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationEditRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationEditRequest:
        """Create an instance of OrganizationEditRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrganizationEditRequest.parse_obj(obj)

        _obj = OrganizationEditRequest.parse_obj({
            "name": obj.get("name"),
