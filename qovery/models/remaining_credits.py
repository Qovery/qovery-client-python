...
class RemainingCredits(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemainingCredits:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RemainingCredits:
        """Create an instance of RemainingCredits from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemainingCredits.parse_obj(obj)

        _obj = RemainingCredits.parse_obj({
