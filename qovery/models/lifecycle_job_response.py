...
class LifecycleJobResponse(BaseModel):
    ...
    schedule: LifecycleJobResponseAllOfSchedule = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LifecycleJobResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LifecycleJobResponse:
        """Create an instance of LifecycleJobResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LifecycleJobResponse.parse_obj(obj)

        _obj = LifecycleJobResponse.parse_obj({
            "id": obj.get("id"),
