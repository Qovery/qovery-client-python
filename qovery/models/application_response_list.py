...
class ApplicationResponseList(BaseModel):
    ...
    """
    results: Optional[conlist(Application)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationResponseList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationResponseList:
        """Create an instance of ApplicationResponseList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationResponseList.parse_obj(obj)

        _obj = ApplicationResponseList.parse_obj({
