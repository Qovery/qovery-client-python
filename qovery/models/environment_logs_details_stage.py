...
class EnvironmentLogsDetailsStage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnvironmentLogsDetailsStage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnvironmentLogsDetailsStage:
        """Create an instance of EnvironmentLogsDetailsStage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnvironmentLogsDetailsStage.parse_obj(obj)

        _obj = EnvironmentLogsDetailsStage.parse_obj({
            "step": obj.get("step"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
