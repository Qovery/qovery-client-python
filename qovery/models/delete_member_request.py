...
class DeleteMemberRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteMemberRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteMemberRequest:
        """Create an instance of DeleteMemberRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteMemberRequest.parse_obj(obj)

        _obj = DeleteMemberRequest.parse_obj({
