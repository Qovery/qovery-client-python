...
class OrganizationApiTokenCreate(BaseModel):
    ...
    token: Optional[StrictStr] = Field(default=None, description="the generated token to send in 'Authorization' header prefixed by 'Token '")
    role_name: Optional[StrictStr] = None
    role_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "name", "description", "token", "role_name", "role_id"]
