...
class HelmResponseAllOfSourceOneOf1(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HelmResponseAllOfSourceOneOf1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HelmResponseAllOfSourceOneOf1:
        """Create an instance of HelmResponseAllOfSourceOneOf1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HelmResponseAllOfSourceOneOf1.parse_obj(obj)
