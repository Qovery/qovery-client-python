...
class SignUpRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["first_name", "last_name", "user_email", "type_of_use", "qovery_usage", "company_name", "company_size", "user_role", "qovery_usage_other", "user_questions", "current_step", "dx_auth"]
