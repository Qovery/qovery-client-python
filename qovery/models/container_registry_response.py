...
class ContainerRegistryResponse(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description="URL of the container registry")
    cluster: Optional[ContainerRegistryResponseAllOfCluster] = None
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "name", "kind", "description", "url", "cluster"]
