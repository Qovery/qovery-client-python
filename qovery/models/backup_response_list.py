...
class BackupResponseList(BaseModel):
    """
    BackupResponseList
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BackupResponseList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BackupResponseList:
        """Create an instance of BackupResponseList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BackupResponseList.parse_obj(obj)

        _obj = BackupResponseList.parse_obj({
