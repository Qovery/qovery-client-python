...
class OrganizationBillingUsageReportResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationBillingUsageReportResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationBillingUsageReportResponse:
        """Create an instance of OrganizationBillingUsageReportResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrganizationBillingUsageReportResponse.parse_obj(obj)

        _obj = OrganizationBillingUsageReportResponse.parse_obj({
