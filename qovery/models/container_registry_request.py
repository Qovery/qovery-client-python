...
class ContainerRegistryRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContainerRegistryRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContainerRegistryRequest:
        """Create an instance of ContainerRegistryRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContainerRegistryRequest.parse_obj(obj)

        _obj = ContainerRegistryRequest.parse_obj({
            "name": obj.get("name"),
            "kind": obj.get("kind"),
