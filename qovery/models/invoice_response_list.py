...
class InvoiceResponseList(BaseModel):
    ...
    InvoiceResponseList
    """
    results: Optional[conlist(Invoice)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InvoiceResponseList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InvoiceResponseList:
        """Create an instance of InvoiceResponseList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InvoiceResponseList.parse_obj(obj)

        _obj = InvoiceResponseList.parse_obj({
