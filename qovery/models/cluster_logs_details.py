...
class ClusterLogsDetails(BaseModel):
    """
    Present only for `info`, `warning` and `debug` logs  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterLogsDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterLogsDetails:
        """Create an instance of ClusterLogsDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClusterLogsDetails.parse_obj(obj)

        _obj = ClusterLogsDetails.parse_obj({
