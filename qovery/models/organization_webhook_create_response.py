...
class OrganizationWebhookCreateResponse(BaseModel):
    """
    ...
    target_url: Optional[StrictStr] = Field(default=None, description="Set the public HTTP or HTTPS endpoint that will receive the specified events. The target URL must starts with `http://` or `https://` ")
    ...
    events: Optional[List[OrganizationWebhookEventEnum]] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "kind", "target_url", "target_secret_set", "description", "enabled", "events", "project_names_filter", "environment_types_filter"]
