...
class OrganizationWebhookCreateResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationWebhookCreateResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationWebhookCreateResponse:
        """Create an instance of OrganizationWebhookCreateResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrganizationWebhookCreateResponse.parse_obj(obj)

        _obj = OrganizationWebhookCreateResponse.parse_obj({
            "id": obj.get("id"),
