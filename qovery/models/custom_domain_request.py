...
class CustomDomainRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomDomainRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomDomainRequest:
        """Create an instance of CustomDomainRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomDomainRequest.parse_obj(obj)

        _obj = CustomDomainRequest.parse_obj({
