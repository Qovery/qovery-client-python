...
class ProjectCurrentCost(BaseModel):
    ...
    id: StrictStr
    name: StrictStr
    consumed_time_in_seconds: StrictInt
    cost: Cost
    environments: Optional[List[GenericObjectCurrentCost]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "consumed_time_in_seconds", "cost", "environments"]
