...
class JobRequestAllOfScheduleOnStart(BaseModel):
    """
    ...
    __properties = ["arguments", "entrypoint"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobRequestAllOfScheduleOnStart:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobRequestAllOfScheduleOnStart:
        """Create an instance of JobRequestAllOfScheduleOnStart from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JobRequestAllOfScheduleOnStart.parse_obj(obj)

        _obj = JobRequestAllOfScheduleOnStart.parse_obj({
