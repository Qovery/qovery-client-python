...
class JobRequestAllOfSourceImage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobRequestAllOfSourceImage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobRequestAllOfSourceImage:
        """Create an instance of JobRequestAllOfSourceImage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JobRequestAllOfSourceImage.parse_obj(obj)

        _obj = JobRequestAllOfSourceImage.parse_obj({
