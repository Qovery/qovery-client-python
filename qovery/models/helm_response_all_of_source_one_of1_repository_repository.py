...
class HelmResponseAllOfSourceOneOf1RepositoryRepository(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HelmResponseAllOfSourceOneOf1RepositoryRepository:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HelmResponseAllOfSourceOneOf1RepositoryRepository:
        """Create an instance of HelmResponseAllOfSourceOneOf1RepositoryRepository from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HelmResponseAllOfSourceOneOf1RepositoryRepository.parse_obj(obj)

        _obj = HelmResponseAllOfSourceOneOf1RepositoryRepository.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "url": obj.get("url")
        })
