...
class HelmResponseAllOfValuesOverrideFileGit(BaseModel):
    ...
    paths: List[StrictStr] = Field(description="List of path inside your git repository to locate values file. Must start by a /")
    __properties: ClassVar[List[str]] = ["git_repository", "paths"]
