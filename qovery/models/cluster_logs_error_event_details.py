...
class ClusterLogsErrorEventDetails(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterLogsErrorEventDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterLogsErrorEventDetails:
        """Create an instance of ClusterLogsErrorEventDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClusterLogsErrorEventDetails.parse_obj(obj)

        _obj = ClusterLogsErrorEventDetails.parse_obj({
