...
class AvailableContainerRegistryResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AvailableContainerRegistryResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AvailableContainerRegistryResponse:
        """Create an instance of AvailableContainerRegistryResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AvailableContainerRegistryResponse.parse_obj(obj)

        _obj = AvailableContainerRegistryResponse.parse_obj({
            "kind": obj.get("kind"),
