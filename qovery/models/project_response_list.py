...
class ProjectResponseList(BaseModel):
    ...
    ProjectResponseList
    """
    results: Optional[conlist(Project)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectResponseList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectResponseList:
        """Create an instance of ProjectResponseList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectResponseList.parse_obj(obj)

        _obj = ProjectResponseList.parse_obj({
