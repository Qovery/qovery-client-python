...
class ProjectDeploymentRulesPriorityOrderRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectDeploymentRulesPriorityOrderRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectDeploymentRulesPriorityOrderRequest:
        """Create an instance of ProjectDeploymentRulesPriorityOrderRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectDeploymentRulesPriorityOrderRequest.parse_obj(obj)
