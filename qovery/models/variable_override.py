...
class VariableOverride(BaseModel):
    ...
    value: Optional[StrictStr] = Field(default=None, description="The value of the overriden variable")
    ...
    __properties: ClassVar[List[str]] = ["id", "key", "value", "mount_path", "scope", "variable_type"]
