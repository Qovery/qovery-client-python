...
class HelmRepositoryRequest(BaseModel):
    ...
    url: Optional[StrictStr] = Field(default=None, description="URL of the helm chart repository: * For `OCI`: it must start by oci:// * For `HTTPS`: it must be start by https:// ")
    ...
    __properties: ClassVar[List[str]] = ["name", "kind", "description", "url", "skip_tls_verification", "config"]
