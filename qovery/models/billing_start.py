...
class BillingStart(BaseModel):
    ...
    __properties = ["billing_started_on"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BillingStart:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BillingStart:
        """Create an instance of BillingStart from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BillingStart.parse_obj(obj)

        _obj = BillingStart.parse_obj({
