...
class OrganizationApiToken(BaseModel):
    ...
    __properties = ["id", "created_at", "updated_at", "name", "description", "role_name", "role_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationApiToken:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationApiToken:
        """Create an instance of OrganizationApiToken from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrganizationApiToken.parse_obj(obj)

        _obj = OrganizationApiToken.parse_obj({
            "id": obj.get("id"),
