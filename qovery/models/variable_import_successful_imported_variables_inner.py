...
class VariableImportSuccessfulImportedVariablesInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariableImportSuccessfulImportedVariablesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariableImportSuccessfulImportedVariablesInner:
        """Create an instance of VariableImportSuccessfulImportedVariablesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariableImportSuccessfulImportedVariablesInner.parse_obj(obj)

        _obj = VariableImportSuccessfulImportedVariablesInner.parse_obj({
            "name": obj.get("name"),
            "value": obj.get("value"),
            "scope": obj.get("scope"),
