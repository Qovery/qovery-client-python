...
class EnvironmentVariableAlias(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnvironmentVariableAlias:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnvironmentVariableAlias:
        """Create an instance of EnvironmentVariableAlias from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnvironmentVariableAlias.parse_obj(obj)

        _obj = EnvironmentVariableAlias.parse_obj({
            "id": obj.get("id"),
            "key": obj.get("key"),
            "value": obj.get("value"),
