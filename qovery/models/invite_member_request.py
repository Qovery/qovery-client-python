...
class InviteMemberRequest(BaseModel):
    ...
    role_id: Optional[StrictStr] = Field(default=None, description="the target role to attribute to the new member")
    __properties: ClassVar[List[str]] = ["email", "role", "role_id"]
