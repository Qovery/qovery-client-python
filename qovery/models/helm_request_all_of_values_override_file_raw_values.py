...
class HelmRequestAllOfValuesOverrideFileRawValues(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the value file")
    content: Optional[StrictStr] = Field(default=None, description="The content of the value file")
