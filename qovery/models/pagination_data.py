...
class PaginationData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginationData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginationData:
        """Create an instance of PaginationData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginationData.parse_obj(obj)

        _obj = PaginationData.parse_obj({
            "page": obj.get("page"),
