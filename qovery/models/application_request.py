...
class ApplicationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["storage", "ports", "name", "description", "git_repository", "build_mode", "dockerfile_path", "buildpack_language", "cpu", "memory", "min_running_instances", "max_running_instances", "healthchecks", "auto_preview", "arguments", "entrypoint", "auto_deploy"]
