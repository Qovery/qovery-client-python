...
class ScalewayCredentialsRequest(BaseModel):
    ...
    scaleway_access_key: StrictStr = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScalewayCredentialsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScalewayCredentialsRequest:
        """Create an instance of ScalewayCredentialsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ScalewayCredentialsRequest.parse_obj(obj)

        _obj = ScalewayCredentialsRequest.parse_obj({
            "name": obj.get("name"),
