...
class ApplicationEditRequest(BaseModel):
    ...
    dockerfile_path: Optional[StrictStr] = Field(default=None, description="The path of the associated Dockerfile")
    ...
    __properties: ClassVar[List[str]] = ["storage", "name", "description", "git_repository", "build_mode", "dockerfile_path", "buildpack_language", "cpu", "memory", "min_running_instances", "max_running_instances", "healthchecks", "auto_preview", "ports", "arguments", "entrypoint", "auto_deploy"]
