...
class ApplicationEditRequest(BaseModel):
    ...
    dockerfile_path: Optional[StrictStr] = Field(None, description="The path of the associated Dockerfile")
    ...
    __properties = ["storage", "name", "description", "git_repository", "build_mode", "dockerfile_path", "buildpack_language", "cpu", "memory", "min_running_instances", "max_running_instances", "healthchecks", "auto_preview", "ports", "arguments", "entrypoint", "auto_deploy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationEditRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationEditRequest:
        """Create an instance of ApplicationEditRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationEditRequest.parse_obj(obj)

        _obj = ApplicationEditRequest.parse_obj({
