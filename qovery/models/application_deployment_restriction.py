...
class ApplicationDeploymentRestriction(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApplicationDeploymentRestriction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApplicationDeploymentRestriction:
        """Create an instance of ApplicationDeploymentRestriction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApplicationDeploymentRestriction.parse_obj(obj)

        _obj = ApplicationDeploymentRestriction.parse_obj({
            "id": obj.get("id"),
