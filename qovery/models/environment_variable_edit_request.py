...
class EnvironmentVariableEditRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnvironmentVariableEditRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnvironmentVariableEditRequest:
        """Create an instance of EnvironmentVariableEditRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnvironmentVariableEditRequest.parse_obj(obj)

        _obj = EnvironmentVariableEditRequest.parse_obj({
            "key": obj.get("key"),
            "value": obj.get("value")
        })
