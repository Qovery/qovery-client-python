...
class VariableEditRequest(BaseModel):
    """
    VariableEditRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariableEditRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariableEditRequest:
        """Create an instance of VariableEditRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariableEditRequest.parse_obj(obj)

        _obj = VariableEditRequest.parse_obj({
            "key": obj.get("key"),
            "value": obj.get("value")
        })
