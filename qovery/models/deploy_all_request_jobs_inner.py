...
class DeployAllRequestJobsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeployAllRequestJobsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeployAllRequestJobsInner:
        """Create an instance of DeployAllRequestJobsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeployAllRequestJobsInner.parse_obj(obj)

        _obj = DeployAllRequestJobsInner.parse_obj({
            "id": obj.get("id"),
