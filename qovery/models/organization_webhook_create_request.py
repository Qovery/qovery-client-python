...
class OrganizationWebhookCreateRequest(BaseModel):
    ...
    """
    kind: OrganizationWebhookKindEnum = Field(...)
    ...
    target_secret: Optional[StrictStr] = Field(None, description="Make sure you receive a payload to sign the Qovery request with your secret. Qovery will add a HTTP header `Qovery-Signature: <Your Secret>` to every webhook requests sent to your target URL. ")
    description: Optional[StrictStr] = None
    enabled: Optional[StrictBool] = Field(None, description="Turn on or off your endpoint.")
    events: conlist(OrganizationWebhookEventEnum) = Field(...)
    ...
    __properties = ["kind", "target_url", "target_secret", "description", "enabled", "events", "project_names_filter", "environment_types_filter"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationWebhookCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationWebhookCreateRequest:
        """Create an instance of OrganizationWebhookCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrganizationWebhookCreateRequest.parse_obj(obj)

        _obj = OrganizationWebhookCreateRequest.parse_obj({
            "kind": obj.get("kind"),
