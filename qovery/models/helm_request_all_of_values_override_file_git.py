...
class HelmRequestAllOfValuesOverrideFileGit(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HelmRequestAllOfValuesOverrideFileGit:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HelmRequestAllOfValuesOverrideFileGit:
        """Create an instance of HelmRequestAllOfValuesOverrideFileGit from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HelmRequestAllOfValuesOverrideFileGit.parse_obj(obj)

        _obj = HelmRequestAllOfValuesOverrideFileGit.parse_obj({
