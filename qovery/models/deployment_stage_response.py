...
class DeploymentStageResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeploymentStageResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeploymentStageResponse:
        """Create an instance of DeploymentStageResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeploymentStageResponse.parse_obj(obj)

        _obj = DeploymentStageResponse.parse_obj({
            "id": obj.get("id"),
