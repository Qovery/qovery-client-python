...
class VariableImportRequestVarsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariableImportRequestVarsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariableImportRequestVarsInner:
        """Create an instance of VariableImportRequestVarsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariableImportRequestVarsInner.parse_obj(obj)

        _obj = VariableImportRequestVarsInner.parse_obj({
            "name": obj.get("name"),
            "value": obj.get("value"),
            "scope": obj.get("scope"),
