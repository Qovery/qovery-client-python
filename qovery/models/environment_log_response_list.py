...
class EnvironmentLogResponseList(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnvironmentLogResponseList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnvironmentLogResponseList:
        """Create an instance of EnvironmentLogResponseList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnvironmentLogResponseList.parse_obj(obj)

        _obj = EnvironmentLogResponseList.parse_obj({
