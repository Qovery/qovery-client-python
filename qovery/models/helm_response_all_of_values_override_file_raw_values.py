...
class HelmResponseAllOfValuesOverrideFileRawValues(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HelmResponseAllOfValuesOverrideFileRawValues:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HelmResponseAllOfValuesOverrideFileRawValues:
        """Create an instance of HelmResponseAllOfValuesOverrideFileRawValues from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HelmResponseAllOfValuesOverrideFileRawValues.parse_obj(obj)

        _obj = HelmResponseAllOfValuesOverrideFileRawValues.parse_obj({
            "name": obj.get("name"),
