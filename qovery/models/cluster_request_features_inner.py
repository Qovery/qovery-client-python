...
class ClusterRequestFeaturesInner(BaseModel):
    ...
    value: Optional[ClusterRequestFeaturesInnerValue] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "value": ClusterRequestFeaturesInnerValue.from_dict(obj.get("value")) if obj.get("value") is not None else None
        })
        return _obj
