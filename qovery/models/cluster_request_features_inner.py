...
class ClusterRequestFeaturesInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterRequestFeaturesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterRequestFeaturesInner:
        """Create an instance of ClusterRequestFeaturesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClusterRequestFeaturesInner.parse_obj(obj)

        _obj = ClusterRequestFeaturesInner.parse_obj({
            "id": obj.get("id"),
