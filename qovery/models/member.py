...
class Member(BaseModel):
    ...
    last_activity_at: Optional[datetime] = Field(default=None, description="last time the user was connected")
    role: Optional[InviteMemberRoleEnum] = None
    role_name: Optional[StrictStr] = Field(default=None, description="the role linked to the user")
    role_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "name", "nickname", "email", "profile_picture_url", "last_activity_at", "role", "role_name", "role_id"]
