...
class HelmPortRequest(BaseModel):
    """
    HelmPortRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HelmPortRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HelmPortRequest:
        """Create an instance of HelmPortRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HelmPortRequest.parse_obj(obj)

        _obj = HelmPortRequest.parse_obj({
