...
class BaseJobResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "environment", "maximum_cpu", "maximum_memory", "name", "description", "cpu", "memory", "max_nb_restart", "max_duration_seconds", "auto_preview", "port", "source", "healthchecks", "auto_deploy"]
