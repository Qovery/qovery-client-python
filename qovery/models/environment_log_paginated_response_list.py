...
class EnvironmentLogPaginatedResponseList(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnvironmentLogPaginatedResponseList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnvironmentLogPaginatedResponseList:
        """Create an instance of EnvironmentLogPaginatedResponseList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnvironmentLogPaginatedResponseList.parse_obj(obj)

        _obj = EnvironmentLogPaginatedResponseList.parse_obj({
            "page": obj.get("page"),
