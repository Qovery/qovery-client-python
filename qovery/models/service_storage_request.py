...
class ServiceStorageRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceStorageRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceStorageRequest:
        """Create an instance of ServiceStorageRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceStorageRequest.parse_obj(obj)

        _obj = ServiceStorageRequest.parse_obj({
