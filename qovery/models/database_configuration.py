...
class DatabaseConfiguration(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatabaseConfiguration:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatabaseConfiguration:
        """Create an instance of DatabaseConfiguration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatabaseConfiguration.parse_obj(obj)

        _obj = DatabaseConfiguration.parse_obj({
