...
class ProbeTypeHttp(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProbeTypeHttp:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProbeTypeHttp:
        """Create an instance of ProbeTypeHttp from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProbeTypeHttp.parse_obj(obj)

        _obj = ProbeTypeHttp.parse_obj({
