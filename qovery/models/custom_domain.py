...
class CustomDomain(BaseModel):
    ...
    validation_domain: Optional[StrictStr] = Field(default=None, description="URL provided by Qovery. You must create a CNAME on your DNS provider using that URL")
    status: Optional[CustomDomainStatusEnum] = None
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "domain", "generate_certificate", "validation_domain", "status"]
