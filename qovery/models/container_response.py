...
class ContainerResponse(BaseModel):
    ...
    min_running_instances: Annotated[int, Field(strict=True, ge=0)] = Field(description="Minimum number of instances running. This resource auto-scale based on the CPU and Memory consumption. Note: 0 means that there is no container running. ")
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "storage", "image_name", "tag", "registry_id", "registry", "environment", "maximum_cpu", "maximum_memory", "name", "description", "arguments", "entrypoint", "cpu", "memory", "min_running_instances", "max_running_instances", "healthchecks", "auto_preview", "ports", "auto_deploy"]
