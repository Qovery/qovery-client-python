...
class VariableResponse(BaseModel):
    ...
    service_id: Optional[StrictStr] = Field(default=None, description="The id of the service referenced by this variable.")
    service_name: Optional[StrictStr] = Field(default=None, description="The name of the service referenced by this variable.")
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "key", "value", "mount_path", "overridden_variable", "aliased_variable", "scope", "variable_type", "service_id", "service_name", "service_type", "owned_by", "is_secret"]
