...
class Organization(BaseModel):
    ...
    owner: Optional[StrictStr] = Field(default=None, description="uuid of the user owning the organization")
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "name", "description", "plan", "website_url", "repository", "logo_url", "icon_url", "admin_emails", "owner"]
