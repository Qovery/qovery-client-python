...
class HelmDefaultValuesRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HelmDefaultValuesRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HelmDefaultValuesRequest:
        """Create an instance of HelmDefaultValuesRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HelmDefaultValuesRequest.parse_obj(obj)
