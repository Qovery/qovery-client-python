...
class EnvironmentLogsDetailsTransmitter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnvironmentLogsDetailsTransmitter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnvironmentLogsDetailsTransmitter:
        """Create an instance of EnvironmentLogsDetailsTransmitter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnvironmentLogsDetailsTransmitter.parse_obj(obj)

        _obj = EnvironmentLogsDetailsTransmitter.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type")
        })
