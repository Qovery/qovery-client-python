...
class ClusterRoutingTableRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterRoutingTableRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterRoutingTableRequest:
        """Create an instance of ClusterRoutingTableRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClusterRoutingTableRequest.parse_obj(obj)
