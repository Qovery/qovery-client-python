...
class ProbeTypeGrpc(BaseModel):
    """
    ProbeTypeGrpc
    """
    service: Optional[StrictStr] = None
    port: Optional[StrictInt] = None
    __properties = ["service", "port"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProbeTypeGrpc:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProbeTypeGrpc:
        """Create an instance of ProbeTypeGrpc from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProbeTypeGrpc.parse_obj(obj)

        _obj = ProbeTypeGrpc.parse_obj({
