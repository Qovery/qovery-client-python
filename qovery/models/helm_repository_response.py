...
class HelmRepositoryResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HelmRepositoryResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HelmRepositoryResponse:
        """Create an instance of HelmRepositoryResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HelmRepositoryResponse.parse_obj(obj)

        _obj = HelmRepositoryResponse.parse_obj({
            "id": obj.get("id"),
