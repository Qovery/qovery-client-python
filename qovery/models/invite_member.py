...
class InviteMember(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "email", "role", "invitation_link", "invitation_status", "organization_name", "inviter", "logo_url", "role_id", "role_name"]
