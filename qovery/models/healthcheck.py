...
class Healthcheck(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["readiness_probe", "liveness_probe"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.readiness_probe is None and "readiness_probe" in self.model_fields_set:
            _dict['readiness_probe'] = None

        # set to None if liveness_probe (nullable) is None
        # and model_fields_set contains the field
        if self.liveness_probe is None and "liveness_probe" in self.model_fields_set:
