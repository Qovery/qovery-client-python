...
class ContainerRegistryProviderDetailsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContainerRegistryProviderDetailsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContainerRegistryProviderDetailsResponse:
        """Create an instance of ContainerRegistryProviderDetailsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContainerRegistryProviderDetailsResponse.parse_obj(obj)

        _obj = ContainerRegistryProviderDetailsResponse.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "url": obj.get("url"),
            "kind": obj.get("kind")
