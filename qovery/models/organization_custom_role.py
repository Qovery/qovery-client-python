...
class OrganizationCustomRole(BaseModel):
    ...
    cluster_permissions: Optional[List[OrganizationCustomRoleClusterPermissionsInner]] = None
    project_permissions: Optional[List[OrganizationCustomRoleProjectPermissionsInner]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "description", "cluster_permissions", "project_permissions"]
