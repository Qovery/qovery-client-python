...
class ClusterRequest(BaseModel):
    ...
    disk_size: Optional[StrictInt] = Field(default=40, description="Unit is in GB. The disk size to be used for the node configuration")
    ...
    kubeconfig: Optional[StrictStr] = Field(default=None, description="If the cluster is a self managed one. The kubeconfig to use to connect to it")
    features: Optional[List[ClusterRequestFeaturesInner]] = None
    __properties: ClassVar[List[str]] = ["name", "description", "region", "cloud_provider", "cloud_provider_credentials", "min_running_nodes", "max_running_nodes", "disk_size", "instance_type", "kubernetes", "production", "ssh_keys", "kubeconfig", "features"]
