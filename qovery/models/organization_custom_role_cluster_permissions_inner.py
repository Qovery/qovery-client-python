...
class OrganizationCustomRoleClusterPermissionsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationCustomRoleClusterPermissionsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationCustomRoleClusterPermissionsInner:
        """Create an instance of OrganizationCustomRoleClusterPermissionsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrganizationCustomRoleClusterPermissionsInner.parse_obj(obj)

        _obj = OrganizationCustomRoleClusterPermissionsInner.parse_obj({
