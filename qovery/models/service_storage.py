...
class ServiceStorage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceStorage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceStorage:
        """Create an instance of ServiceStorage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceStorage.parse_obj(obj)

        _obj = ServiceStorage.parse_obj({
