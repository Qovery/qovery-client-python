...
class OrganizationApiTokenCreateRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrganizationApiTokenCreateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrganizationApiTokenCreateRequest:
        """Create an instance of OrganizationApiTokenCreateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrganizationApiTokenCreateRequest.parse_obj(obj)

        _obj = OrganizationApiTokenCreateRequest.parse_obj({
            "name": obj.get("name"),
