...
class EnvironmentStatus(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "state", "last_deployment_date", "last_deployment_state", "last_deployment_id", "total_deployment_duration_in_seconds", "origin", "triggered_by"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.last_deployment_date is None and "last_deployment_date" in self.model_fields_set:
            _dict['last_deployment_date'] = None

        # set to None if last_deployment_id (nullable) is None
        # and model_fields_set contains the field
        if self.last_deployment_id is None and "last_deployment_id" in self.model_fields_set:
            _dict['last_deployment_id'] = None

        # set to None if total_deployment_duration_in_seconds (nullable) is None
        # and model_fields_set contains the field
        if self.total_deployment_duration_in_seconds is None and "total_deployment_duration_in_seconds" in self.model_fields_set:
