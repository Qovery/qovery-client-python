...
class ClusterLogs(BaseModel):
    ...
    ClusterLogs
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="log level")
    timestamp: Optional[datetime] = Field(default=None, description="log date creation")
    step: Optional[StrictStr] = Field(default=None, description="log step")
    message: Optional[ClusterLogsMessage] = None
    error: Optional[ClusterLogsError] = None
    details: Optional[ClusterLogsDetails] = None
    __properties: ClassVar[List[str]] = ["type", "timestamp", "step", "message", "error", "details"]
