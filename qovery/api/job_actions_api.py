...
class JobActionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.redeploy_job_endpoint = _Endpoint(
            settings={
                'response_type': (Status,),
                'auth': [
                    'ApiKeyAuth',
    ...
    def redeploy_job(
        ...
        **kwargs
        ...
        >>> thread = api.redeploy_job(job_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['job_id'] = \
            job_id
        return self.redeploy_job_endpoint.call_with_http_info(**kwargs)
