...
class CustomDomainApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_helm_custom_domain_endpoint = _Endpoint(
            settings={
                'response_type': (CustomDomain,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/helm/{helmId}/customDomain',
                'operation_id': 'create_helm_custom_domain',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.list_helm_custom_domain_endpoint = _Endpoint(
            settings={
                'response_type': (CustomDomainResponseList,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/helm/{helmId}/customDomain',
                'operation_id': 'list_helm_custom_domain',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def create_helm_custom_domain(
        ...
        **kwargs
        ...
        >>> thread = api.create_helm_custom_domain(helm_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['helm_id'] = \
            helm_id
        return self.create_helm_custom_domain_endpoint.call_with_http_info(**kwargs)
    ...
    def list_helm_custom_domain(
        ...
        **kwargs
        ...
        kwargs['helm_id'] = \
            helm_id
        return self.list_helm_custom_domain_endpoint.call_with_http_info(**kwargs)
