...
class JobConfigurationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.edit_job_advanced_settings_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'edit_job_advanced_settings',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        self.get_job_advanced_settings_endpoint = _Endpoint(
            settings={
                'response_type': (JobAdvancedSettings,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/job/{jobId}/advancedSettings',
                'operation_id': 'get_job_advanced_settings',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
