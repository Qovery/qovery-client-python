...
class EnvironmentExportApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.export_environment_configuration_into_terraform_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'export_environment_configuration_into_terraform',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def export_environment_configuration_into_terraform(
        ...
        **kwargs
        ...
        >>> thread = api.export_environment_configuration_into_terraform(environment_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_id'] = \
            environment_id
        return self.export_environment_configuration_into_terraform_endpoint.call_with_http_info(**kwargs)
