...
class MembersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.edit_organization_member_role_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearerAuth'
                ...
                'endpoint_path': '/organization/{organizationId}/member',
                'operation_id': 'edit_organization_member_role',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'organization_id': 'path',
                    'member_role_update_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.get_member_invitation_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/organization/{organizationId}/inviteMember/{inviteId}',
                'operation_id': 'get_member_invitation',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def edit_organization_member_role(
        ...
        **kwargs
        ...
        >>> thread = api.edit_organization_member_role(organization_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            member_role_update_request (MemberRoleUpdateRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['organization_id'] = \
            organization_id
        return self.edit_organization_member_role_endpoint.call_with_http_info(**kwargs)
    ...
    def get_member_invitation(
        ...
        **kwargs
        ...
        kwargs['invite_id'] = \
            invite_id
        return self.get_member_invitation_endpoint.call_with_http_info(**kwargs)
