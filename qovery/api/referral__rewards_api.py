...
class ReferralRewardsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_account_referral_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'get_account_referral',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.post_account_reward_claim_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearerAuth'
                ...
                'operation_id': 'post_account_reward_claim',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def get_account_referral(
        ...
        **kwargs
        ...
        return self.get_account_referral_endpoint.call_with_http_info(**kwargs)
    ...
    def post_account_reward_claim(
        ...
        **kwargs
        ...
        >>> thread = api.post_account_reward_claim(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.post_account_reward_claim_endpoint.call_with_http_info(**kwargs)
