...
class EnvironmentActionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_selected_services_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/environment/{environmentId}/service/delete',
                'operation_id': 'delete_selected_services',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'environment_id': 'path',
                    'environment_service_ids_all_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.reboot_services_endpoint = _Endpoint(
            settings={
                'response_type': (Status,),
                'auth': [
                    'ApiKeyAuth',
        ...
        self.redeploy_environment_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'redeploy_environment',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.stop_selected_services_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/environment/{environmentId}/service/stop',
                'operation_id': 'stop_selected_services',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def delete_selected_services(
        ...
        **kwargs
        ...
        >>> thread = api.delete_selected_services(environment_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            environment_service_ids_all_request (EnvironmentServiceIdsAllRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['environment_id'] = \
            environment_id
        return self.delete_selected_services_endpoint.call_with_http_info(**kwargs)
    ...
    def reboot_services(
        ...
        **kwargs
        ...
        >>> thread = api.reboot_services(environment_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            reboot_services_request (RebootServicesRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['environment_id'] = \
            environment_id
        return self.reboot_services_endpoint.call_with_http_info(**kwargs)
    ...
    def redeploy_environment(
        ...
        **kwargs
        ...
        >>> thread = api.redeploy_environment(environment_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_id'] = \
            environment_id
        return self.redeploy_environment_endpoint.call_with_http_info(**kwargs)
    ...
    def stop_selected_services(
        ...
        **kwargs
        ...
        >>> thread = api.stop_selected_services(environment_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_id'] = \
            environment_id
        return self.stop_selected_services_endpoint.call_with_http_info(**kwargs)
