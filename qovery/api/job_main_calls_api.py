...
class JobMainCallsApi:
    ...
    def edit_job(
        ...
        _param = self._edit_job_serialize(
            job_id=job_id,
    ...
    @validate_call
    def edit_job_without_preload_content(
        self,
        job_id: Annotated[StrictStr, Field(description="Job ID")],
        job_request: Optional[JobRequest] = None,
        _request_timeout: Union[
    ...
    def _get_job_status_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/job/{jobId}/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_job_commit(
        ...
        _param = self._list_job_commit_serialize(
            job_id=job_id,
            start_id=start_id,
    ...
    @validate_call
    def list_job_commit_with_http_info(
        self,
        job_id: Annotated[StrictStr, Field(description="Job ID")],
        start_id: Annotated[Optional[StrictStr], Field(description="Starting point after which to return results")] = None,
        git_commit_id: Annotated[Optional[StrictStr], Field(description="Git Commit ID")] = None,
    ...
    @validate_call
    def list_job_commit_without_preload_content(
        self,
        job_id: Annotated[StrictStr, Field(description="Job ID")],
        start_id: Annotated[Optional[StrictStr], Field(description="Starting point after which to return results")] = None,
        git_commit_id: Annotated[Optional[StrictStr], Field(description="Git Commit ID")] = None,
    ...
    def _list_job_commit_serialize(
        self,
        job_id,
        start_id,
        git_commit_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/job/{jobId}/commit',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
