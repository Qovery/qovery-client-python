...
class ClustersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.edit_cluster_kubeconfig_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/organization/{organizationId}/cluster/{clusterId}/kubeconfig',
                'operation_id': 'edit_cluster_kubeconfig',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
        ...
        self.get_cluster_kubeconfig_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/organization/{organizationId}/cluster/{clusterId}/kubeconfig',
                'operation_id': 'get_cluster_kubeconfig',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_default_cluster_advanced_settings_endpoint = _Endpoint(
            settings={
                'response_type': (ClusterAdvancedSettings,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'operation_id': 'get_default_cluster_advanced_settings',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_installation_helm_values_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'ApiKeyAuth',
                ...
                'endpoint_path': '/organization/{organizationId}/cluster/{clusterId}/installationHelmValues',
                'operation_id': 'get_installation_helm_values',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def edit_cluster_kubeconfig(
        ...
        **kwargs
        ...
        >>> thread = api.edit_cluster_kubeconfig(organization_id, cluster_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.edit_cluster_kubeconfig_endpoint.call_with_http_info(**kwargs)
    ...
    def get_cluster_kubeconfig(
        ...
        **kwargs
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.get_cluster_kubeconfig_endpoint.call_with_http_info(**kwargs)
    ...
    def get_default_cluster_advanced_settings(
        ...
        **kwargs
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_default_cluster_advanced_settings_endpoint.call_with_http_info(**kwargs)
    ...
    def get_installation_helm_values(
        ...
        **kwargs
        ...
        kwargs['cluster_id'] = \
            cluster_id
        return self.get_installation_helm_values_endpoint.call_with_http_info(**kwargs)
