...
class JobDeploymentHistoryApi:
    ...
    def list_job_deployment_history(
        ...
        _param = self._list_job_deployment_history_serialize(
            job_id=job_id,
    ...
    @validate_call
    def list_job_deployment_history_with_http_info(
        self,
        job_id: Annotated[StrictStr, Field(description="Job ID")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListJobDeploymentHistory200Response]:
        """List job deployments
    ...
    @validate_call
    def list_job_deployment_history_without_preload_content(
        self,
        job_id: Annotated[StrictStr, Field(description="Job ID")],
        _request_timeout: Union[
            None,
    ...
    def _list_job_deployment_history_serialize(
        self,
        job_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/job/{jobId}/deploymentHistory',
