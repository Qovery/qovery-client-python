...
class DatabasesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.clone_database_endpoint = _Endpoint(
            settings={
    ...
    def clone_database(
        ...
        **kwargs
        ...
        >>> thread = api.clone_database(database_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['database_id'] = \
            database_id
        return self.clone_database_endpoint.call_with_http_info(**kwargs)
