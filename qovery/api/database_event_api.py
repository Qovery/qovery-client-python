...
class DatabaseEventApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_database_event_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'list_database_event',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def list_database_event(
        ...
        **kwargs
        ...
        >>> thread = api.list_database_event(database_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['database_id'] = \
            database_id
        return self.list_database_event_endpoint.call_with_http_info(**kwargs)
