...
class ContainerDependencyApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_container_dependency_endpoint = _Endpoint(
            settings={
                'response_type': (ContainerResponse,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/container/{containerId}/dependency/{targetContainerId}',
                'operation_id': 'create_container_dependency',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.list_container_dependency_endpoint = _Endpoint(
            settings={
                'response_type': (ContainerResponseList,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/container/{containerId}/dependency',
                'operation_id': 'list_container_dependency',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.remove_container_dependency_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'bearerAuth'
                ...
                'endpoint_path': '/container/{containerId}/dependency/{targetContainerId}',
                'operation_id': 'remove_container_dependency',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
    ...
    def list_container_dependency(
        ...
        **kwargs
        ...
        >>> thread = api.list_container_dependency(container_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['container_id'] = \
            container_id
        return self.list_container_dependency_endpoint.call_with_http_info(**kwargs)

    def remove_container_dependency(
        self,
        container_id,
        **kwargs
    ):
        ...
        >>> thread = api.remove_container_dependency(container_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['container_id'] = \
            container_id
        return self.remove_container_dependency_endpoint.call_with_http_info(**kwargs)
