...
class EnvironmentLogsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_environment_log_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'list_environment_log',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.list_environment_logs_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'list_environment_logs',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def list_environment_log(
        ...
        **kwargs
        ...
        kwargs['environment_id'] = \
            environment_id
        return self.list_environment_log_endpoint.call_with_http_info(**kwargs)
    ...
    def list_environment_logs(
        ...
        **kwargs
        ...
        >>> thread = api.list_environment_logs(environment_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['environment_id'] = \
            environment_id
        return self.list_environment_logs_endpoint.call_with_http_info(**kwargs)
