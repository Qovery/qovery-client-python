...
class ContainerEventApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_container_event_endpoint = _Endpoint(
            settings={
                'response_type': (EventPaginatedResponseList,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/container/{containerId}/event',
                'operation_id': 'list_container_event',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def list_container_event(
        ...
        **kwargs
        ...
        >>> thread = api.list_container_event(container_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['container_id'] = \
            container_id
        return self.list_container_event_endpoint.call_with_http_info(**kwargs)
