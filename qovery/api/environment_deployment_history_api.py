...
class EnvironmentDeploymentHistoryApi:
    ...
    @validate_call
    def list_environment_deployment_history(
        self,
        ...
        _param = self._list_environment_deployment_history_serialize(
    ...
    @validate_call
    def list_environment_deployment_history_with_http_info(
        self,
        environment_id: Annotated[StrictStr, Field(description="Environment ID")],
        start_id: Annotated[Optional[StrictStr], Field(description="Starting point after which to return results")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeploymentHistoryEnvironmentPaginatedResponseList]:
        """List environment deployments
    ...
    @validate_call
    def list_environment_deployment_history_without_preload_content(
        self,
        environment_id: Annotated[StrictStr, Field(description="Environment ID")],
        start_id: Annotated[Optional[StrictStr], Field(description="Starting point after which to return results")] = None,
        _request_timeout: Union[
    ...
    def _list_environment_deployment_history_serialize(
        self,
        environment_id,
        start_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/environment/{environmentId}/deploymentHistory',
