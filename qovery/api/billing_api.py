...
class BillingApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.generate_billing_usage_report_endpoint = _Endpoint(
            settings={
                'response_type': (OrganizationBillingUsageReportResponse,),
                'auth': [
                    'ApiKeyAuth',
                    'bearerAuth'
                ],
                'endpoint_path': '/organization/{organizationId}/billingUsageReport',
                'operation_id': 'generate_billing_usage_report',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'organization_id': 'path',
                    'organization_billing_usage_report_request': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.get_organization_billing_external_id_endpoint = _Endpoint(
            settings={
                'response_type': (BillingExternalId,),
                'auth': [
                    'ApiKeyAuth',
                    'bearerAuth'
                ],
                'endpoint_path': '/organization/{organizationId}/billingExternalId',
                'operation_id': 'get_organization_billing_external_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def change_plan(
        ...
        **kwargs
        ...
        >>> thread = api.change_plan(organization_id, async_req=True)
        >>> result = thread.get()
    ...
    def generate_billing_usage_report(
        self,
        organization_id,
        **kwargs
    ):
        ...
        >>> thread = api.generate_billing_usage_report(organization_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            organization_billing_usage_report_request (OrganizationBillingUsageReportRequest): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['organization_id'] = \
            organization_id
        return self.generate_billing_usage_report_endpoint.call_with_http_info(**kwargs)
    ...
    def get_organization_billing_external_id(
        ...
        **kwargs
        ...
        kwargs['organization_id'] = \
            organization_id
        return self.get_organization_billing_external_id_endpoint.call_with_http_info(**kwargs)
