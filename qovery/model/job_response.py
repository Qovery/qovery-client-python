...
class JobResponse(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'schedule': (CronJobResponseAllOfSchedule,),  # noqa: E501
        }
    ...
    def discriminator():
        ...
        val = {
            ...
            'LIFECYCLE': LifecycleJobResponse,
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            job_type (str): defaults to "CRON", must be one of ["CRON", ]  # noqa: E501
            ...
            maximum_cpu (int): Maximum cpu that can be allocated to the job based on organization cluster configuration. unit is millicores (m). 1000m = 1 cpu. [optional]  # noqa: E501
            maximum_memory (int): Maximum memory that can be allocated to the job based on organization cluster configuration. unit is MB. 1024 MB = 1GB. [optional]  # noqa: E501
            ...
            schedule (CronJobResponseAllOfSchedule): [optional]  # noqa: E501
        """

        job_type = kwargs.get('job_type', "CRON")
