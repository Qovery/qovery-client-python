...
class InviteMemberResponseAllOf(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, role, invitation_link, invitation_status, inviter, *args, **kwargs):  # noqa: E501
        """InviteMemberResponseAllOf - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, role, invitation_link, invitation_status, inviter, *args, **kwargs):  # noqa: E501
        """InviteMemberResponseAllOf - a model defined in OpenAPI
