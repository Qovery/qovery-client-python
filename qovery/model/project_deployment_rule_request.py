...
def lazy_import():
    ...
    globals()['DeploymentRuleRequest'] = DeploymentRuleRequest


class ProjectDeploymentRuleRequest(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'environment_target': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
            'mode': (str,),  # noqa: E501
    ...
    attribute_map = {
        'environment_target': 'environment_target',  # noqa: E501
        'name': 'name',  # noqa: E501
        'mode': 'mode',  # noqa: E501
