...
class MetricStorageResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': ([MetricStorageDatapointResponse],),  # noqa: E501
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """MetricStorageResponse - a model defined in OpenAPI

        Args:
            data ([MetricStorageDatapointResponse]):
