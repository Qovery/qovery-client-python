...
class ApplicationAdvancedSettingsResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ApplicationAdvancedSettingsResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ApplicationAdvancedSettings]):  # noqa: E501

        Keyword Args:
            value ([ApplicationAdvancedSettings]):  # noqa: E501
