...
class ApplicationAdvancedSettings(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            network_ingress_proxy_buffering (str): Allows to enable or disable nginx `proxy-request-buffering`. [optional]  # noqa: E501
            ...
            network_ingress_basic_auth_env_var (str): Set the name of an environment variable to use as a basic authentication (`login:crypted_password`) from `htpasswd` command. . [optional]  # noqa: E501
