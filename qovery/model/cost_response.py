...
class CostResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, total_in_cents, total, currency_code, *args, **kwargs):  # noqa: E501
        """CostResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, total_in_cents, total, currency_code, *args, **kwargs):  # noqa: E501
        """CostResponse - a model defined in OpenAPI
