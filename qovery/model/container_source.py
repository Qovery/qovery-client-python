...
class ContainerSource(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, image_name, tag, registry, *args, **kwargs):  # noqa: E501
        """ContainerSource - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, image_name, tag, registry, *args, **kwargs):  # noqa: E501
        """ContainerSource - a model defined in OpenAPI
