...
class GitRepositoryResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, url, *args, **kwargs):  # noqa: E501
        """GitRepositoryResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, url, *args, **kwargs):  # noqa: E501
        """GitRepositoryResponse - a model defined in OpenAPI
