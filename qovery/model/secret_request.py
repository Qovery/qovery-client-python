...
class SecretRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, key, *args, **kwargs):  # noqa: E501
        """SecretRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            value (str): value of the secret. Clear value will never be returned. [optional]  # noqa: E501
