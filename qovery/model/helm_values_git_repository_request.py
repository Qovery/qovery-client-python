...
class HelmValuesGitRepositoryRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, url, branch, paths, *args, **kwargs):  # noqa: E501
        """HelmValuesGitRepositoryRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, url, branch, paths, *args, **kwargs):  # noqa: E501
        """HelmValuesGitRepositoryRequest - a model defined in OpenAPI
