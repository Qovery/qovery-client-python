...
class HelmRepositoryRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, name, kind, skip_tls_verification, config, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            url (str): URL of the helm chart repository: * For `OCI`: it must start by oci:// * For `HTTPS`: it must be start by https:// . [optional]  # noqa: E501
        """
