...
class ListHelmDeploymentHistory200ResponseAllOfResultsInnerAllOf(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ListHelmDeploymentHistory200ResponseAllOfResultsInnerAllOf - a model defined in OpenAPI
