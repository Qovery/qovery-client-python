...
class HelmPortRequestPortsInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, internal_port, service_name, *args, **kwargs):  # noqa: E501
        """HelmPortRequestPortsInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, internal_port, service_name, *args, **kwargs):  # noqa: E501
        """HelmPortRequestPortsInner - a model defined in OpenAPI
