...
class Probe(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            success_threshold (int): [optional] if omitted the server will use the default value of 1  # noqa: E501
            failure_threshold (int): [optional] if omitted the server will use the default value of 9  # noqa: E501
        """
