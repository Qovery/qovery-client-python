...
class VariableImportRequestVarsInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, value, scope, is_secret, *args, **kwargs):  # noqa: E501
        """VariableImportRequestVarsInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, value, scope, is_secret, *args, **kwargs):  # noqa: E501
        """VariableImportRequestVarsInner - a model defined in OpenAPI
