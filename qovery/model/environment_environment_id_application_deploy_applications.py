...
class EnvironmentEnvironmentIdApplicationDeployApplications(ModelNormal):
    ...
    def _from_openapi_data(cls, application_id, git_commit_id, *args, **kwargs):  # noqa: E501
        """EnvironmentEnvironmentIdApplicationDeployApplications - a model defined in OpenAPI
