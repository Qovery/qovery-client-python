...
class DeploymentRuleRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'weekdays': ([WeekdayEnum], none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, mode, cluster, *args, **kwargs):  # noqa: E501
        """DeploymentRuleRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            auto_stop (bool): defaults to False  # noqa: E501
            ...
            weekdays ([WeekdayEnum], none_type): specify value only if auto_stop = false. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, mode, cluster, *args, **kwargs):  # noqa: E501
        """DeploymentRuleRequest - a model defined in OpenAPI
