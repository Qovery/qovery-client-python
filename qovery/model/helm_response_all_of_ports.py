...
class HelmResponseAllOfPorts(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, internal_port, service_name, protocol, *args, **kwargs):  # noqa: E501
        """HelmResponseAllOfPorts - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, internal_port, service_name, protocol, *args, **kwargs):  # noqa: E501
        """HelmResponseAllOfPorts - a model defined in OpenAPI
