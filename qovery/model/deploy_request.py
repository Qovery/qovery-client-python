...
class DeployRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, git_commit_id, *args, **kwargs):  # noqa: E501
        """DeployRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, git_commit_id, *args, **kwargs):  # noqa: E501
        """DeployRequest - a model defined in OpenAPI
