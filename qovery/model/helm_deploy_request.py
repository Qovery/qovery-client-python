...
class HelmDeployRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """HelmDeployRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            chart_version (str): version of the chart to deploy. Cannot be set if `git_commit_id` is defined . [optional]  # noqa: E501
