...
class ServicePortRequestList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ServicePortRequestList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ServicePortRequest]):  # noqa: E501

        Keyword Args:
            value ([ServicePortRequest]):  # noqa: E501
