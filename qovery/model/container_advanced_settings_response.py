...
class ContainerAdvancedSettingsResponse(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """ContainerAdvancedSettingsResponse - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([ContainerAdvancedSettings]):  # noqa: E501

        Keyword Args:
            value ([ContainerAdvancedSettings]):  # noqa: E501
