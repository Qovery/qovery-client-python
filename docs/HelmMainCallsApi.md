...
[**get_default_values**](HelmMainCallsApi.md#get_default_values) | **GET** /helm/{helmId}/defaultValues | Display the contents of the values.yaml file
...
# **get_default_values**
> str get_default_values(helm_id)
...
with qovery.ApiClient(configuration) as api_client:
    ...
    try:
        # Display the contents of the values.yaml file
        api_response = api_instance.get_default_values(helm_id)
        pprint(api_response)
    except qovery.ApiException as e:
        print("Exception when calling HelmMainCallsApi->get_default_values: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Display the contents of the values.yaml file |  -  |
**401** | Access token is missing or invalid |  -  |
**403** | Access forbidden |  -  |
**404** | Resource not found |  -  |
