...
base_job_response_instance = BaseJobResponse.from_json(json)
# print the JSON string representation of the object
print BaseJobResponse.to_json()

# convert the object into a dict
base_job_response_dict = base_job_response_instance.to_dict()
# create an instance of BaseJobResponse from a dict
base_job_response_form_dict = base_job_response.from_dict(base_job_response_dict)
```
