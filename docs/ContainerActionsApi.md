...
[**preview_environment_container**](ContainerActionsApi.md#preview_environment_container) | **POST** /container/{containerId}/previewEnvironment | Deploy a preview environment with your container application
