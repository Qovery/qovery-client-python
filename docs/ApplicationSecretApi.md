...
> SecretResponse create_application_secret(application_id)
...
import time
import qovery
from api import application_secret_api
...
> SecretResponse create_application_secret_alias(application_id, secret_id)
...
> SecretResponse create_application_secret_override(application_id, secret_id)
...
> SecretResponse edit_application_secret(application_id, secret_id, secret_edit_request)
