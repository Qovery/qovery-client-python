...
> CustomDomainResponse create_application_custom_domain(application_id)
...
import time
import qovery
from api import custom_domain_api
...
# **edit_custom_domain**
> CustomDomainResponse edit_custom_domain(application_id, custom_domain_id)
...
> CustomDomainResponse get_custom_domain_status(application_id, custom_domain_id)
