...
[**deploy_all_services**](ApplicationsApi.md#deploy_all_services) | **POST** /environment/{environmentId}/container/deploy | Deploy services
...
with qovery.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ApplicationsApi->deploy_all_services: %s\n" % e)
