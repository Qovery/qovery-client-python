...
[**get_default_cluster_advanced_settings**](ApplicationsApi.md#get_default_cluster_advanced_settings) | **GET** /defaultClusterAdvancedSettings | List default cluster advanced settings
...
with qovery.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling ApplicationsApi->get_default_cluster_advanced_settings: %s\n" % e)
```
