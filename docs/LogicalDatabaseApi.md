...
[**list_logical_database_container**](LogicalDatabaseApi.md#list_logical_database_container) | **GET** /logicalDatabase/{logicalDatabaseId}/container | List linked containers
...
# **list_logical_database_container**
> ContainerResponseList list_logical_database_container(logical_database_id)
...
with qovery.ApiClient(configuration) as api_client:
    ...
    try:
        # List linked containers
        api_response = api_instance.list_logical_database_container(logical_database_id)
        pprint(api_response)
    except qovery.ApiException as e:
        print("Exception when calling LogicalDatabaseApi->list_logical_database_container: %s\n" % e)
```
