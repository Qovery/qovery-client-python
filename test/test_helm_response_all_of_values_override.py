...
from qovery.models.helm_response_all_of_values_override import HelmResponseAllOfValuesOverride  # noqa: E501
...
class TestHelmResponseAllOfValuesOverride(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HelmResponseAllOfValuesOverride:
        """Test HelmResponseAllOfValuesOverride
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HelmResponseAllOfValuesOverride`
        """
        model = HelmResponseAllOfValuesOverride()  # noqa: E501
        if include_optional:
            return HelmResponseAllOfValuesOverride(
                set = [
                    [
                        ''
                        ]
