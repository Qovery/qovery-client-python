...
from qovery.models.environment_variable import EnvironmentVariable  # noqa: E501
    ...
    def make_instance(self, include_optional) -> EnvironmentVariable:
        ...
        if include_optional:
            return EnvironmentVariable(
                ...
                value = '',
                mount_path = '',
                overridden_variable = qovery.models.environment_variable_override.EnvironmentVariableOverride(
                    id = '', 
                    key = '', 
                    value = '', 
                    mount_path = '', 
                    scope = 'APPLICATION', 
                    variable_type = 'VALUE', ),
                aliased_variable = qovery.models.environment_variable_alias.EnvironmentVariableAlias(
                    id = '', 
