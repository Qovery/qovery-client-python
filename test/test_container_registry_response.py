...
from qovery.models.container_registry_response import ContainerRegistryResponse  # noqa: E501
...
class TestContainerRegistryResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContainerRegistryResponse:
        """Test ContainerRegistryResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContainerRegistryResponse`
        """
