...
from qovery.models.container_registry_response_list import ContainerRegistryResponseList  # noqa: E501
...
class TestContainerRegistryResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContainerRegistryResponseList:
        """Test ContainerRegistryResponseList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContainerRegistryResponseList`
        """
