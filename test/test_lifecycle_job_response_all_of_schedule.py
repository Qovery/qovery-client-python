...
from qovery.models.lifecycle_job_response_all_of_schedule import LifecycleJobResponseAllOfSchedule  # noqa: E501
...
class TestLifecycleJobResponseAllOfSchedule(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LifecycleJobResponseAllOfSchedule:
        """Test LifecycleJobResponseAllOfSchedule
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LifecycleJobResponseAllOfSchedule`
        """
        model = LifecycleJobResponseAllOfSchedule()  # noqa: E501
        if include_optional:
            return LifecycleJobResponseAllOfSchedule(
