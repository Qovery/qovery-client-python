...
class TestClusterRequestFeaturesInnerValueOneOf(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClusterRequestFeaturesInnerValueOneOf:
        """Test ClusterRequestFeaturesInnerValueOneOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterRequestFeaturesInnerValueOneOf`
        """
        model = ClusterRequestFeaturesInnerValueOneOf()
        if include_optional:
            return ClusterRequestFeaturesInnerValueOneOf(
                aws_vpc_eks_id = '',
