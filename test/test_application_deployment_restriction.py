...
from qovery.models.application_deployment_restriction import ApplicationDeploymentRestriction  # noqa: E501
...
class TestApplicationDeploymentRestriction(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApplicationDeploymentRestriction:
        """Test ApplicationDeploymentRestriction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationDeploymentRestriction`
        """
