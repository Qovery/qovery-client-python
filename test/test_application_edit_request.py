...
from qovery.models.application_edit_request import ApplicationEditRequest  # noqa: E501
...
class TestApplicationEditRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApplicationEditRequest:
        """Test ApplicationEditRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationEditRequest`
        """
