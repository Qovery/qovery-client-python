...
from qovery.models.deployment_stage_response import DeploymentStageResponse  # noqa: E501
...
class TestDeploymentStageResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeploymentStageResponse:
        """Test DeploymentStageResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeploymentStageResponse`
        """
