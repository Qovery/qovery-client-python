...
from qovery.models.cluster_logs import ClusterLogs  # noqa: E501
...
class TestClusterLogs(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClusterLogs:
        """Test ClusterLogs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterLogs`
        """
