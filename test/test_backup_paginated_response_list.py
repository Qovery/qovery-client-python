...
from qovery.models.backup_paginated_response_list import BackupPaginatedResponseList  # noqa: E501
...
class TestBackupPaginatedResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BackupPaginatedResponseList:
        """Test BackupPaginatedResponseList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackupPaginatedResponseList`
        """
