...
from qovery.models.helm_deploy_request import HelmDeployRequest  # noqa: E501
...
class TestHelmDeployRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HelmDeployRequest:
        """Test HelmDeployRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HelmDeployRequest`
        """
