...
class TestClusterRequestFeaturesInnerValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClusterRequestFeaturesInnerValue:
        """Test ClusterRequestFeaturesInnerValue
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterRequestFeaturesInnerValue`
        """
        model = ClusterRequestFeaturesInnerValue()
        if include_optional:
