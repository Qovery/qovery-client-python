...
class TestHelmDefaultValuesRequestAllOfSource(unittest.TestCase):
    """HelmDefaultValuesRequestAllOfSource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HelmDefaultValuesRequestAllOfSource:
        """Test HelmDefaultValuesRequestAllOfSource
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HelmDefaultValuesRequestAllOfSource`
        """
        model = HelmDefaultValuesRequestAllOfSource()
        if include_optional:
    ...
    def testHelmDefaultValuesRequestAllOfSource(self):
        """Test HelmDefaultValuesRequestAllOfSource"""
